  ...
  const values = [
    {
      ...
      description:
        "We prioritize the health, comfort, and wellbeing of poultry above all else",
    },
    {
      icon: Lightbulb,
      title: "Innovation Driven",
      description:
        "Constantly developing cutting-edge solutions to solve real farming challenges",
    },
    {
      icon: Users,
      title: "Farmer-Centric",
      description:
        "Every decision we make puts small-scale farmers and their success first",
    },
    {
      icon: Globe,
      title: "Sustainability",
      description:
        "Building climate-adaptive solutions for a sustainable agricultural future",
    },
  ];
  ...
  return (
    <div className="pt-20">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-600 to-green-600">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl opacity-90">
            A social enterprise revolutionizing small-scale poultry farming
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-gradient-to-br from-green-50 to-green-50 rounded-3xl shadow-xl p-10">
              ...
              <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
                To empower small-scale poultry farmers with accessible,
                affordable smart farming technology that enhances animal
                welfare, increases productivity, and builds climate resilience.
                We're committed to transforming traditional farming practices
                through innovation that makes a tangible difference in farmers'
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-50 rounded-3xl shadow-xl p-10">
              ...
              <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
                To become Africa's leading smart agriculture platform, where
                every small-scale poultry farmer has access to technology that
                enables sustainable, profitable farming. We envision a future
                where data-driven insights and IoT solutions are standard tools
                for farmers adapting to climate change and market demands.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
                Kiota Poultry was founded in 2025 by a team of agricultural
                economists, IoT engineers, and passionate farmers who saw the
                challenges facing small-scale poultry producers firsthand. We
                witnessed how climate change, disease outbreaks, and lack of
                real-time data were affecting farm productivity and animal
                welfare.
              </p>
              <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
                We knew technology could help, but existing solutions were too
                expensive and complex for small-scale farmers. So we set out to
                build something different: affordable IoT sensors, intuitive
                mobile apps, and AI analytics specifically designed for the
                realities of Kenyan poultry farming.
              </p>
              <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
                Today, we're proud to support over 500 farms across Kenya,
                monitoring more than 10 million birds and helping farmers
                increase their productivity by an average of 35% while
                greenucing mortality rates by 15%. But we're just getting
                started.
              </p>
            </div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        >
          <source src="chicks.mov" type="video/mp4" />
        </video>
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div
                key={index}
                className="bg-white/10 backdrop-blur-md rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all transform hover:-translate-y-2"
              >
