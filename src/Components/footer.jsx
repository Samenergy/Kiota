        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <div className="flex space-x-3">
              <a href="#" className="w-9 h-9 bg-gray-800 hover:bg-orange-600 rounded-lg flex items-center justify-center transition-colors">
                <Facebook size={18} />
              </a>
              <a href="#" className="w-9 h-9 bg-gray-800 hover:bg-orange-600 rounded-lg flex items-center justify-center transition-colors">
                <Twitter size={18} />
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/app" className="text-gray-400 hover:text-orange-400 transition-colors">Download App</Link></li>
              <li><Link to="/dashboard" className="text-gray-400 hover:text-orange-400 transition-colors">Dashboard Demo</Link></li>
              <li><Link to="/contact" className="text-gray-400 hover:text-orange-400 transition-colors">Contact Us</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-400 hover:text-orange-400 transition-colors">API Reference</a></li>
              <li><a href="#" className="text-gray-400 hover:text-orange-400 transition-colors">Community Forum</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start space-x-2">
                <Mail className="text-orange-400 flex-shrink-0 mt-0.5" size={16} />
                <span className="text-gray-400">info@kiotapoultry.com</span>
              </li>
              <li className="flex items-start space-x-2">
                <Phone className="text-orange-400 flex-shrink-0 mt-0.5" size={16} />
                <span className="text-gray-400">+254 700 000 000</span>
              </li>
              <li className="flex items-start space-x-2">
                <MapPin className="text-orange-400 flex-shrink-0 mt-0.5" size={16} />
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-2">
                ...
                />
                <button className="px-3 py-2 bg-orange-600 hover:bg-orange-700 rounded-lg transition-colors">
