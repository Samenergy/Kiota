  ...
  const faqs = [
    {
      ...
      answer:
        "We can have your system up and running within 3-5 business days after order confirmation. This includes sensor installation, app setup, and initial training.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "All sensors come with a 2-year warranty. We provide free replacement for any hardware failures during the warranty period.",
    },
  ];
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-orange-600 to-red-600">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl opacity-90">
            Have questions? We're here to help you transform your poultry farm
          </p>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-700 text-lg mb-8">
                  ...
                  ready to assist you with any questions about our smart farming
                  solutions.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-2xl shadow-xl p-6 text-white">
                ...
                <div className="flex space-x-3">
                  <button className="w-12 h-12 bg-white/20 hover:bg-white/30 rounded-lg flex items-center justify-center transition-all">
                    <svg
                      className="w-6 h-6"
                      fill="currentColor"
                      viewBox="0 0 24 24"
